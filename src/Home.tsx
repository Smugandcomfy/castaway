...
/// The splash: instrument approached, not app opened. Paper theme
/// (light, warm), the real orrery beneath, one door in.
///
...
export default function Home({ onEnter }: { onEnter: () => void }) {
  return (
    <main className="nt-app nt-app--fill cast-away ca-home ca-paper">
